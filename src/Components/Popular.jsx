...
const Popular = () => {
  ...
  return (
      <div className='pt-8 px-8 md:pt-10 md:px-14 mb-8'>
          <h1 className='font-bold md:text-xl text-lg text-[#fff] flex items-center gap-1'>What's Popular <Emoji Emoji={Emojies.faceInClouds} width={'6'} height={'6'} /></h1>
          <div  className='mt-4 '>
              <Splide  options={{
              height: '280px',
              perMove: 1,
              ...
              pagination: false,
                  ...
                  {
                      popular?.slice(0,8)?.map((res , index ) => (
             ...
             <SplideSlide>
            <Link to={'/popular'} className='min-w-[200px] group h-full flex items-center justify-center rounded-md bg-[#222222] relative hover:opacity-80 transition-all duration-200 ease-in-out'>
